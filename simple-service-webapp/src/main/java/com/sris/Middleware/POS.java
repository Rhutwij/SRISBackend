...
/**
 * 2015
 * code take from https://github.com/edreichua/postagging  by edreichua POS tagging 11/29/2015
 * Part of Speech tagger
 *
 * Created by rhutwij tulankar
 */
...
public class POS{
    ...
    public static String ViterbiFile(String filename){
        ...
        try{
            tagfile = filename.substring(0,filename.length()-4) + "_Viterbi_tag1.txt";
    ...
    public static void main(String[] args){
        // the train files
        String trainfile = "src/main/resources/brown-train-sentences.txt", traintag = "src/main/resources/brown-train-tags.txt";
        // the test files
        String testfile = "src/main/resources/simple-test-sentences.txt", testtag = "src/main/resources/brown-test-tags.txt";
